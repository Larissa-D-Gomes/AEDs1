/* exemplo03e1 - v0.0.1 - 19 / 08 / 2019    Author: Larissa Domingues Gomes-650525  
    Para compilar em terminal (janela de comandos):    
    Linux      : gcc -o exemplo03e1    exemplo032e1    
    Windows: gcc -o exemplo03e1.exe exemplo03e1 
 
   Para executar em terminal (janela de comandos):   
  Linux      :  ./exemplo03e1    Windows:   exemplo03e1  */ 
    #include <stdio.h>
int main()
{
   printf("exemplo03e1 - v0.0.1");
