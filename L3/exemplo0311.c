/* exemplo0311 - v0.0.1 - 13 / 08 / 2019    Author: Larissa Domingues Gomes-650525  
    Para compilar em terminal (janela de comandos):    
    Linux      : gcc -o exemplo0311    exemplo0311    
    Windows: gcc -o exemplo0311.exe exemplo0311 
 
   Para executar em terminal (janela de comandos):   
    Linux      :  ./exemplo0311    Windows:   exemplo0311  */ 
