/* exemplo0318 - v0.0.1 - 18 / 08 / 2019    Author: Larissa Domingues Gomes-650525  
    Para compilar em terminal (janela de comandos):    
    Linux      : gcc -o exemplo0318    exemplo0318    
    Windows: gcc -o exemplo0318.exe exemplo0318 
 
   Para executar em terminal (janela de comandos):   
    Linux      :  ./exemplo0318    Windows:   exemplo0318  */ 

#include <stdio.h>

int main()
{
   printf("exemplo0318 - v0.0.1");
