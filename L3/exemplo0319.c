/* exemplo0319 - v0.0.1 - 19 / 08 / 2019    Author: Larissa Domingues Gomes-650525  
    Para compilar em terminal (janela de comandos):    
    Linux      : gcc -o exemplo0319    exemplo0319    
    Windows: gcc -o exemplo0319.exe exemplo0319 
 
   Para executar em terminal (janela de comandos):   
  Linux      :  ./exemplo0319    Windows:   exemplo0319  */ 
    #include <stdio.h>

int main()
{
   printf("exemplo0319 - v0.0.1");
