/* exemplo0314 - v0.0.1 - 13 / 08 / 2019    Author: Larissa Domingues Gomes-650525  
    Para compilar em terminal (janela de comandos):    
    Linux      : gcc -o exemplo0314    exemplo0314    
    Windows: gcc -o exemplo0314.exe exemplo0314 
 
   Para executar em terminal (janela de comandos):   
    Linux      :  ./exemplo0314    Windows:   exemplo0314  */ 

#include <stdio.h>

int main()
{
   printf("exemplo0314 - v0.0.1");
