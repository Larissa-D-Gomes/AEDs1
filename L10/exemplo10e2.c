...
#include <stdbool.h>
#include <string.h>
/* exemplo10e2 - v0.0.1 - 11 / 10 / 2019    Author: Larissa Domingues Gomes-650525  
    Para compilar em terminal (janela de comandos):    
    Linux      : gcc -o exemplo10e2    exemplo10e2    
    Windows: gcc -o exemplo10e2.exe  exemplo10e2 
 
   Para executar em terminal (janela de comandos):   
  Linux      :  ./exemplo10e2   Windows:   exemplo10e2  */ 
void metodo0()
{
