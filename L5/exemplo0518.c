...
/* exemplo0518 - v0.0.1 - 31 / 08 / 2019    Author: Larissa Domingues Gomes-650525  
    Para compilar em terminal (janela de comandos):    
    Linux      : gcc -o exemplo0518    exemplo0518    
    Windows: gcc -o exemplo0518.exe  exemplo0518 
 
   Para executar em terminal (janela de comandos):   
  Linux      :  ./exemplo518   Windows:   exemplo0518  */ 
int main(){
   int x = 0;
   void metodo0();
   void metodo1();
