...
/* exemplo0517 - v0.0.1 - 31 / 08 / 2019    Author: Larissa Domingues Gomes-650525  
    Para compilar em terminal (janela de comandos):    
    Linux      : gcc -o exemplo0517    exemplo0517    
    Windows: gcc -o exemplo0517.exe  exemplo0517 
 
   Para executar em terminal (janela de comandos):   
  Linux      :  ./exemplo517   Windows:   exemplo0517  */ 
int main(){
   int x = 0;
   void metodo0();
   void metodo1();
