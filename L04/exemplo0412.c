/* exemplo0412 - v0.0.1 - 19 / 08 / 2019    Author: Larissa Domingues Gomes-650525  
    Para compilar em terminal (janela de comandos):    
    Linux      : gcc -o exemplo0412    exemplo0412    
    Windows: gcc -o exemplo0412.exe exemplo0412 
 
   Para executar em terminal (janela de comandos):   
  Linux      :  ./exemplo0412   Windows:   exemplo0412  */ 
    #include <stdio.h>
