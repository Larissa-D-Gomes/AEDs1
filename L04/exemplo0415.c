/* exemplo0415 - v0.0.1 - 23 / 08 / 2019    Author: Larissa Domingues Gomes-650525  
    Para compilar em terminal (janela de comandos):    
    Linux      : gcc -o exemplo0415    exemplo0415   
    Windows: gcc -o exemplo0415.exe exemplo0415 
 
   Para executar em terminal (janela de comandos):   
  Linux      :  ./exemplo0415   Windows:   exemplo0415  */ 
    #include <stdio.h>
