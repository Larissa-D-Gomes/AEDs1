...
#include <stdbool.h>
#include <stdlib.h>
/* exemplo09e2 - v0.0.1 - 30 / 09 / 2019    Author: Larissa Domingues Gomes-650525  
    Para compilar em terminal (janela de comandos):    
    Linux      : gcc -o exemplo09e2    exemplo09e2    
    Windows: gcc -o exemplo09e2.exe  exemplo09e2 
 
   Para executar em terminal (janela de comandos):   
  Linux      :  ./exemplo09e2   Windows:   exemplo09e2  */ 
void metodo0();
void metodo1();
void metodo3();
void metodo4();
