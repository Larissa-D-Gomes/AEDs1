/* exemplo0315 - v0.0.1 - 13 / 08 / 2019    Author: Larissa Domingues Gomes-650525  
    Para compilar em terminal (janela de comandos):    
    Linux      : gcc -o exemplo0315    exemplo0315    
    Windows: gcc -o exemplo0315.exe exemplo0315 
 
   Para executar em terminal (janela de comandos):   
    Linux      :  ./exemplo0315    Windows:   exemplo0315  */ 
