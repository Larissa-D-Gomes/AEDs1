/* exemplo0320 - v0.0.1 - 19 / 08 / 2019    Author: Larissa Domingues Gomes-650525  
    Para compilar em terminal (janela de comandos):    
    Linux      : gcc -o exemplo0320    exemplo0320    
    Windows: gcc -o exemplo0320.exe exemplo0320 
 
   Para executar em terminal (janela de comandos):   
  Linux      :  ./exemplo0320    Windows:   exemplo0320  */ 
    #include <stdio.h>

int main()
{
   printf("exemplo0320 - v0.0.1");
