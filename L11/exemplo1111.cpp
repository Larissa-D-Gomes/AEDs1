...
/* exemplo1111 - v0.0.1 - 16 / 10 / 2019    Author: Larissa Domingues Gomes-650525  
    Para compilar em terminal (janela de comandos):    
    Linux      : g++ -o exemplo1111    exemplo1111    
    Windows: g++ -o exemplo1111.exe  exemplo1111 
 
   Para executar em terminal (janela de comandos):   
  Linux      :  ./exemplo1111   Windows:   exemplo1111  */ 
using namespace std;
void metodo0();
void metodo1();
void metodo2();
...
void metodo12()
{
   ...
   Arranjo <int>* a =new  Arranjo <int> (n);
   Arranjo <int>* b =new  Arranjo <int> (m); 
   if(a->retornotamanho() == b->retornotamanho())
   {
      Arranjo <int>* c = (*a-b);
      c->printarray();
      c->free();
