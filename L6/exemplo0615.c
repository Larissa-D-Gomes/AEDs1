...
/* exemplo0615 - v0.0.1 - 02 / 09 / 2019    Author: Larissa Domingues Gomes-650525  
    Para compilar em terminal (janela de comandos):    
    Linux      : gcc -o exemplo0615    exemplo0615    
    Windows: gcc -o exemplo0615.exe  exemplo0615 
 
   Para executar em terminal (janela de comandos):   
  Linux      :  ./exemplo0615   Windows:   exemplo0615  */ 
int main(){
   int x = 0;
   void metodo0();
   void metodo1();
