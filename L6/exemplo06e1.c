...
/* exemplo06e1 - v0.0.1 - 05 / 09 / 2019    Author: Larissa Domingues Gomes-650525  
    Para compilar em terminal (janela de comandos):    
    Linux      : gcc -o exemplo06e1    exemplo06e1    
    Windows: gcc -o exemplo06e1.exe  exemplo06e1 
 
   Para executar em terminal (janela de comandos):   
  Linux      :  ./exemplo06e1   Windows:   exemplo06e1  */ 
int main(){
   int x = 0;
   void metodo0();
   void metodo1();
