...
/* exemplo0516 - v0.0.1 - 31 / 08 / 2019    Author: Larissa Domingues Gomes-650525  
    Para compilar em terminal (janela de comandos):    
    Linux      : gcc -o exemplo0516    exemplo0516    
    Windows: gcc -o exemplo0516.exe  exemplo0516 
 
   Para executar em terminal (janela de comandos):   
  Linux      :  ./exemplo516   Windows:   exemplo0516  */ 
int main(){
   int x = 0;
   void metodo0();
   void metodo1();
