#include <stdio.h>
#include <math.h>
/* exemplo0520 - v0.0.1 - 31 / 08 / 2019    Author: Larissa Domingues Gomes-650525  
    Para compilar em terminal (janela de comandos):    
    Linux      : gcc -o exemplo0520    exemplo0520    
    Windows: gcc -o exemplo0520.exe  exemplo0520 
 
   Para executar em terminal (janela de comandos):   
  Linux      :  ./exemplo520   Windows:   exemplo0520  */ 
int main(){
   int x = 0;
   void metodo0();
   void metodo1();
