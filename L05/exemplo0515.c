...
/* exemplo0515 - v0.0.1 - 29 / 08 / 2019    Author: Larissa Domingues Gomes-650525  
    Para compilar em terminal (janela de comandos):    
    Linux      : gcc -o exemplo0515    exemplo0515    
    Windows: gcc -o exemplo0515.exe  exemplo0515 
 
   Para executar em terminal (janela de comandos):   
  Linux      :  ./exemplo515   Windows:   exemplo0515  */ 
int main(){
   int x = 0;
   void metodo0();
   void metodo1();
