...
/* exemplo0519 - v0.0.1 - 31 / 08 / 2019    Author: Larissa Domingues Gomes-650525  
    Para compilar em terminal (janela de comandos):    
    Linux      : gcc -o exemplo0519    exemplo0519    
    Windows: gcc -o exemplo0519.exe  exemplo0519 
 
   Para executar em terminal (janela de comandos):   
  Linux      :  ./exemplo519   Windows:   exemplo0519  */ 
int main(){
   int x = 0;
   void metodo0();
   void metodo1();
