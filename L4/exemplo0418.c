/* exemplo0418 - v0.0.1 - 23 / 08 / 2019    Author: Larissa Domingues Gomes-650525  
    Para compilar em terminal (janela de comandos):    
    Linux      : gcc -o exemplo0418    exemplo0418   
    Windows: gcc -o exemplo0418.exe exemplo0418 
 
   Para executar em terminal (janela de comandos):   
  Linux      :  ./exemplo0418   Windows:   exemplo0418  */ 
#include <stdio.h>
